...
Cuando pedir frames extra cambie tu decisión respecto a la que hubieras tomado antes de verlos, registra en el veredicto correspondiente (via el razonamiento que luego resumes en decisionesMd) qué veredicto habrías dado antes y cuál diste después, y qué cambió. Esta información se usa para el registro de auditoría, así que sé explícito al respecto en tu razonamiento y en decisionesMd cuando ocurra.
